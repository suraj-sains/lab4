...
def remove_punct(text):
    ...
    # returns a translation table that maps out each character
      # table is translated into function of removing the punctuation
...
def remove_spaces(text):
    ...
    #returns copy of string (from beginning/end of string)
...
def normalise_input(user_input):
    ...
    #here punctuation and text is removed
    #text converted to lower case so that is readable
...
def display_room(room):
    ...
    print("\n" + room["name"].upper() + "\n\n" + room["description"] + "\n")
    # prints room name and it's description
...
def exit_leads_to(exits, direction):
    ...
    #Looks through dictionary and displays name of each exit then prints them out
...
def print_menu_line(direction, leads_to):
    ...
    #prints out "go to ___" where it shows possible exits
...
def print_menu(exits):
    ...
    #prints out possible exits and then asks for input for available outputs
...
def is_valid_exit(exits, user_input):
    ...
    #if the input is valid, user moves to next area - if false, then stops
